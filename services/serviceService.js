...
function normalizeServicePayload(payload) {
  ...
  return {
    ...
    document_template_html: normalizeHtmlContent(payload?.document_template_html),
...
async function serializeService(row, { publicOnly = false } = {}) {
  ...
  const service = {
    ...
    document_template_html: row.document_template_html,
...
function serviceToMutablePayload(service) {
  return {
    ...
    document_template_html: service.document_template_html,
  ...
  await client.query(
    `UPDATE services
     SET document_icon_url = $2,
         ...
         document_template_html = $6,
         document_download_count = $7,
         is_package_featured = $8,
         package_sort_order = $9,
         document_sort_order = $10,
         updated_at = CURRENT_TIMESTAMP
     WHERE id = $1`,
    [
      serviceId,
      ...
      payload.document_template_html,
      payload.document_download_count,
