...
SELECT seed_document_service('Business Suite', 'document-business-suite', 'Essential business documents for operating, contracting, and staying compliant.', 'circle-slash', 'orange', 12400, TRUE, 0, 0, 'business-documents', '[
...
SELECT seed_document_service('GST Packages', 'document-gst-packages', 'Documents and support package for GST registration and basic compliance.', 'handshake', 'blue', 1200, TRUE, 1, 1, 'tax-documents', '[
...
SELECT seed_document_service('NDA', 'document-nda', 'Restricts people from sharing confidential information with others.', 'circle-slash', 'orange', 12400, FALSE, 0, 2, 'agreements', '[
...
SELECT seed_document_service('Service Agreement', 'document-service-agreement', 'For contracts related to services to a second party.', 'handshake', 'blue', 1200, FALSE, 0, 3, 'agreements', '[
...
SELECT seed_document_service('Rent Agreement', 'document-rent-agreement', 'An agreement for renting a house or property.', 'home', 'pink', 7, FALSE, 0, 4, 'property-documents', '[
...
SELECT seed_document_service('Power Of Attorney', 'document-power-of-attorney', 'Authorise someone to act on your behalf for a defined purpose.', 'arrow-left-right', 'green', 250, FALSE, 0, 5, 'personal-legal-documents', '[
...
SELECT seed_document_service('MOA', 'document-moa', 'Memorandum of association for company formation.', 'list', 'pink', 340, FALSE, 0, 6, 'company-documents', '[
...
SELECT seed_document_service('Police Verification', 'document-police-verification', 'Application for police verification for different uses.', 'shield', 'green', 840, FALSE, 0, 7, 'identity-verification', '[
...
SELECT seed_document_service('Employment Agreement', 'document-employment-agreement', 'Employment terms for salary, role, confidentiality, and exit obligations.', 'file-check', 'blue', 910, FALSE, 0, 8, 'employment-documents', '[
...
SELECT seed_document_service('Partnership Deed', 'document-partnership-deed', 'Define partner contributions, profit sharing, and exit terms.', 'handshake', 'violet', 620, FALSE, 0, 9, 'business-documents', '[
...
SELECT seed_document_service('Legal Notice', 'document-legal-notice', 'Draft a formal legal notice for disputes, recovery, or breach.', 'shield', 'slate', 1800, FALSE, 0, 10, 'personal-legal-documents', '[
...
SELECT seed_document_service('Affidavit', 'document-affidavit', 'Prepare an affidavit for declarations, corrections, and official use.', 'file-check', 'green', 540, FALSE, 0, 11, 'personal-legal-documents', '[
...
SELECT seed_document_service('Sale Agreement', 'document-sale-agreement', 'Agreement for selling goods, assets, or property interests.', 'home', 'orange', 430, FALSE, 0, 12, 'agreements', '[
...
SELECT seed_document_service('Trademark Authorization', 'document-trademark-authorization', 'Authorize a representative for trademark filing and related actions.', 'shield', 'blue', 310, FALSE, 0, 13, 'business-documents', '[
...
SELECT seed_document_service('Will Draft', 'document-will-draft', 'Prepare a will for distribution of assets and personal wishes.', 'file-check', 'pink', 460, FALSE, 0, 14, 'personal-legal-documents', '[
